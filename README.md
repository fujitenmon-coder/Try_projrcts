# Try_projects
When you want to try something,come on here.And let's try.they are children of  wisdom.
...
・As the project progresses and existing constraints start to get in the way,
please spin off the project files into a new, independent repository.
Code below
...
---Rules---
This is a testing environment. Please do not stay here indefinitely.
・Do not create folders within each project.
・Do not merge branches or copy files from other branches.
・Do not split branches into multiple branches.
